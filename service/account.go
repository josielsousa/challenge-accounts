...
func (s *AccountService) InsertAccount(_ http.ResponseWriter, _ *http.Request) {
...
//	500: Erro inesperado durante o processamento da requisição
func (s *AccountService) GetAllAccounts(_ http.ResponseWriter, _ *http.Request) {
...
//	500: Erro inesperado durante o processamento da requisição
func (s *AccountService) GetAccountBalance(_ http.ResponseWriter, _ *http.Request) {
